module.exports = function(grunt) {
  ...
  grunt.registerTask("content", "Load content from data files", ["state", "scrape", "scrapeLittleFires", "scrapeCanada", "scrapeCanadaLittleFires", "json", "csv", "markdown", "archieml"]);
