module.exports = function(grunt) {
  ...
  grunt.registerTask("content", "Load content from data files", ["state", "scrape", "scrapeLittleFires", "scrapeCanada", "scrapeCanadaLittleFires", "writeFireNamesObj", "json", "csv", "markdown", "archieml"]);
